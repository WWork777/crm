...
export default async function TasksPage(props: {
  ...
  // const searchQuery = (typeof searchParams.q === 'string' ? searchParams.q : '') as string;
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-400 p-4 sm:p-10 font-sans">
      ...
      <div className="fixed bottom-0 left-0 w-[400px] h-[400px] bg-cyan-600/5 rounded-full blur-[100px] pointer-events-none" />
    </div>
  );
}
